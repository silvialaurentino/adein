...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("R.Salvar") action QuickSave()
            textbutton _("R.Carregar") action QuickLoad()
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Page {}"), auto=_("Salvos automaticamente"), quick=_("Salvos rapidamente"))
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Pular")
                    textbutton _("Textos não lidos") action Preference("skip", "toggle")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Avança diálogos e ativa a interface.")

    hbox:
        label _("Espaço")
        text _("Avança diálogos sem escolhas.")
    ...
    hbox:
        label _("Tab")
        text _("Alterna o modo de pular.")
    ...
    hbox:
        label _("Page Down")
        text _("Avança para o diálogo seguinte.")
    ...
    hbox:
        label "V"
        text _("Alterna {a=https://www.renpy.org/l/voicing}assistente de voz{/a}.")
...
screen mouse_help():
    ...
    hbox:
        label _("Clique no botão de rolagem")
        text _("Esconde a interface.")
